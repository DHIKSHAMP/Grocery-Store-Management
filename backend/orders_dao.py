...
def delete_order(connection, order_id):
    ...
    try:
        ...
        connection.rollback()
        print("Delete order failed:", str(e))  # or use logging
        raise
